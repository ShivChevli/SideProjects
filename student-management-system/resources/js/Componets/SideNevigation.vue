<template>
                ...
                <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " v-show="$route.path !== '/login' && $route.path !== '/register' && $route.path !== '/logout' " id="sidenav-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                        <router-link to="/student" class="nav-link" id="student" >
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <li class="nav-item">
                        <router-link class="nav-link  " :to="{name : 'department' }" id="department">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <router-link to="/register" class="nav-link" >
                            ...
                            <!-- <router-link to="/" class="nav-link-text ms-1">Login</router-link> -->
                        </router-link >
                        </li>
                        <li class="nav-item" v-if="login">
...
<style>
    ...
    .router-link-active .icon svg .color-background{
    fill: #fff !important;
}
